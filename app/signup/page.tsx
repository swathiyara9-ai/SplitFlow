  ...
  return (
    <div className="relative min-h-screen bg-stone-950 text-stone-100 flex items-center justify-center p-6 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute bottom-[-30%] right-[-20%] w-[70vw] h-[70vw] rounded-full bg-orange-600/10 blur-[110px]"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="flex flex-col items-center gap-3 mb-8 text-center">
          ...
          <div>
            ...
            <p className="text-xs text-stone-400">Establish your permanent transaction node</p>
          </div>
        </div>
        ...
        <div className="glass-panel p-6 md:p-8 rounded-premium bg-white/5 border-white/5 shadow-2xl space-y-6">
          ...
          {successMessage ? (
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              {/* Email Field */}
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-stone-400 uppercase tracking-wider">Email Coordinates</label>
                <div className="relative">
              ...
              {/* Password Field */}
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold text-stone-400 uppercase tracking-wider">Secret Key</label>
                <div className="relative">
